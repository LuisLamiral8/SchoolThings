 ...
 * @author info6
 */
public class cuadroDeListas extends javax.swing.JFrame {

    /**
     * Creates new form cuadroDeListas
     */
    public cuadroDeListas() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(cuadroDeListas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new cuadroDeListas().setVisible(true);
            }
        });
    }
